...
jQuery(function() {
    ...
    jQuery('.advfrm-import-form button').click(function () {return advfrm_import(this.form);});

    jQuery('#advfrm-editor > form').submit(advfrm_checkForm);

    jQuery('.toolbar .advfrm-add').click(function () {advfrm_add('advfrm-fields');});
    jQuery('.toolbar .advfrm-delete').click(function () {advfrm_delete('advfrm-fields');});
    jQuery('.toolbar .advfrm-up').click(function () {advfrm_up('advfrm-fields');});
    jQuery('.toolbar .advfrm-down').click(function () {advfrm_down('advfrm-fields');});

    jQuery('.toolbar .advfrm-prop-add').click(function () {advfrm_add('advfrm-prop-fields');});
    jQuery('.toolbar .advfrm-prop-delete').click(function () {advfrm_delete('advfrm-prop-fields');});
    jQuery('.toolbar .advfrm-prop-up').click(function () {advfrm_up('advfrm-prop-fields');});
    jQuery('.toolbar .advfrm-prop-down').click(function () {advfrm_down('advfrm-prop-fields');});
    jQuery('.toolbar .advfrm-prop-clear_defaults').click(function () {advfrm_clear_defaults('advfrm-prop-fields');});
