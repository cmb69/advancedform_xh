...
(function ($) {
    ...
    function advfrm_props() {
        ...
        if (isSelect) {
            ...
            dlg.find('input[name="advfrm-select-props-opt"]').focus(function() {advfrm_highlightRow('advfrm-prop-fields', $(this))});
        } else {
    ...
    function advfrm_checkProperties() {
        ...
        if (advfrm_isSelect(type)) {
            if (advfrm_isRealSelect(type)) {
                var elt = $('#advfrm-select-props-size input');
            ...
            for (var i = 0; i <= 1; i++) {
                if ($.inArray(i, vis) > -1) {
                    var elt = $('#advfrm-text-props input').eq(i);
                    if (elt.val().match(/^[0-9]*$/) == null) {
                        alert(config['error_invalid_property']);
                        elt.focus();
                        return false;
    ...
    $(function() {
        ...
        $('.toolbar .advfrm-prop-add').click(function () {advfrm_add('advfrm-prop-fields');});
        $('.toolbar .advfrm-prop-delete').click(function () {advfrm_delete('advfrm-prop-fields');});
        $('.toolbar .advfrm-prop-up').click(function () {advfrm_up('advfrm-prop-fields');});
        $('.toolbar .advfrm-prop-down').click(function () {advfrm_down('advfrm-prop-fields');});
        $('.toolbar .advfrm-prop-clear_defaults').click(function () {advfrm_clear_defaults('advfrm-prop-fields');});
