Advancedform_XH – a CMSimple_XH plugin
=====================================

[![stable: 1.0](https://img.shields.io/badge/stable-1.0-green.svg)](https://github.com/cmb69/advancedform_xh/releases/tag/1.0)
...
along with Advancedform_XH (see LICENSE).
